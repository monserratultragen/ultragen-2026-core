...
class ImagenAIBaseSerializer(BaseCloudinarySerializer):
    class Meta:
        model = ImagenAIBase
        fields = '__all__'

class CapituloPromptSerializer(BaseCloudinarySerializer):
    class Meta:
        model = CapituloPrompt
        fields = '__all__'
class VisitaSerializer(BaseCloudinarySerializer):
    class Meta:
        model = Visita
        fields = '__all__'
