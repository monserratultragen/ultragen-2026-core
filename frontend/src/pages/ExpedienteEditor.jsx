...
function ExpedienteEditor() {
    ...
    const fetchImagenes = () => {
        api.get(`/expediente-imagenes/?expediente=${id}`)
            .then(res => setImagenes(res.data))
            .catch(err => console.error(err));
    };

    const handleSave = () => {
        api.patch(`/expedientes/${id}/`, { contenido })
    ...
    const handleImageUpload = (e) => {
        ...
        api.post('/expediente-imagenes/', formData, { headers: { 'Content-Type': 'multipart/form-data' } })
            .then(res => {
    ...
    const handleDeleteImage = (imageId) => {
        ...
        api.delete(`/expediente-imagenes/${imageId}/`)
        ...
        <div className="writer-container">
            <div className="writer-top-bar">
                ...
                <div className="writer-actions">
                    <button className="btn btn-secondary" onClick={() => navigate('/expedientes')}>Volver</button>
            ...
            <div className="writer-content-grid">
                <div className="writer-editor-area">
                    <textarea
                        ...
                        placeholder="Escribe aquí el contenido del expediente..."
                    />
                </div>
...
export default ExpedienteEditor;
